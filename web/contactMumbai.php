...
<html>
    ...
    <body>
        ...
        <br><br>
        <div class="heading">
            <center><h1>Security Services - Mumbai</h1></center>
        </div>
        <br>
    <center><h3>Shield Security has a documented history of providing quality security services in Mumbai for corporate and government events.</h3></center><hr>
        <div class="contactmain">
            <div class="row">
                <div class="col-md-12 address">
                    <h3 style="color: #006699">Mumbai Office</h3>
                    <hr>
                    <p>11-b/6, New Sion Co Housing Society,<br> Sion West, Opposite Sies College,<br> Sion West, Mumbai, Maharashtra 400022</p><hr>
                    <h3>CONTACT US - 022 2401 5895 </h3><hr>
